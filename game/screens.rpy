...
init -501 screen navigation():
    ...
    vbox:
        yoffset 400
        xoffset 340
        text "{size=40}I'll finish this if this video does good"
...
init -501 screen main_menu():
    ...
    if not persistent.ghost_menu:
        ...
        #add "menu_particles"
        #add "menu_particles"
        add "menu_assets/black.jpg" at fade_out_effect
        add "menu_logo" at fade_in_effect
        add Movie(play="menu_assets/isuck.webm", loop=True) size(config.screen_width, config.screen_height)
        frame:
            style_prefix "black"
            background "#0004"
            xpadding 5
    ...
    vbox:
        ...
        xoffset 0
        yoffset -200
        textbutton "{font=fonts/main.otf}{size=30}START" action Start(), x == 100 at fade_in_effect style "menu_button"
    ...
    hbox:
        ...
        xalign 0.5
        yoffset 100
        textbutton "{font=fonts/main.otf}{size=30}OPTIONS" action ShowMenu("preferences") at fade_in_effect style "menu_button":
            xoffset 50
            yoffset -70
        textbutton "{font=fonts/main.otf}{size=30}EXIT" action Quit(confirm=True) at fade_in_effect style "menu_button":
            xoffset -82
            yoffset -40
...
init -1 style menu_button:
    hover_sound gui.hover_sound
    activate_sound gui.activate_sound
    color "#FFFFFFFF"
    padding (10, 40)

init -1 style watermark:
    color "#FFFFFFFF"
    background "#0004"
