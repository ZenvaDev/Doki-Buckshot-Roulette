...
#Buckshot menu
transform fade_in_effect:
    alpha 0.0  # Start fully transparent
    linear 2.3 alpha 1.0  # Fade to fully opaque over 1 second

# Define a fade-out transform
transform fade_out_effect:
    alpha 1.0  # Start fully opaque
    linear 2.0 alpha 0.0  # Fade out to fully transparent over 1 second
